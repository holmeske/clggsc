...
@SuppressLint("ParcelCreator")
@Parcelize
data class Check(var code: Int = 0, var id: String? = "", var url: String? = "", var msg: String? = "", var success: Boolean = false) : Parcelable
...
@SuppressLint("ParcelCreator")
@Parcelize
data class Banner(var code: Int = 0, var data: Data? = null, var success: Boolean = false) : Parcelable {
    @Parcelize
    data class Bean(var img: String? = "", var name: String? = "",var details: String? = "", var url: String? = "") : Parcelable

    @Parcelize
    data class Data(var wellChosen: ArrayList<Bean>? = null,
                 var rushLeft: ArrayList<Bean>? = null,
                 var rushRight: ArrayList<Bean>? = null,
                 var banner: ArrayList<Bean>? = null,
                 var hot: ArrayList<Bean>? = null,
                 var carNetBanner: ArrayList<Bean>? = null) : Parcelable
}
