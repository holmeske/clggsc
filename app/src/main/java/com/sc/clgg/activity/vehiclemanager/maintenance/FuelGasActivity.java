...
import com.sc.clgg.activity.presenter.FuelGasPresenter;
...
/**
 * Author：lvke
 * CreateDate：2017/8/15 9:49
 * 加油加气列表
 */
public class FuelGasActivity extends BaseActivity implements CommonContact {
    @BindView(R.id.swipeRefreshLayout)
    SwipeRefreshLayout mSwipeRefreshLayout;
    @BindView(R.id.recyclerView)
    RecyclerView mRecyclerView;

    private FuelGasPresenter presenter;
    ...
    protected void init() {
        ...
        presenter = new FuelGasPresenter(this);
    ...
    private void startActivity() {
        startActivity(new Intent(this, MapActivity.class).putExtra("title", getString(R.string.fuel_gas)).putExtra("cls", getClass()));
    }
