...
import com.sc.clgg.activity.presenter.MaintenancePresenter;
...
public class MaintenanceActivity extends BaseActivity implements CommonContact {
    ...
    private void startActivity() {
        startActivity(new Intent(this, MapActivity.class).putExtra("title", getString(R.string.maintenance)).putExtra("cls", getClass()));
    }
...
//        listAll = DistanceComparator.AddDistance(listAll);
//        DistanceComparator.sort(listAll, DistanceComparator.getInstance());
        if (pageNo==1){
            listAll.clear();
        }
