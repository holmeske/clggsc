...
public class LogisticsParkPresenter {
    private CommonContact contact;

    public LogisticsParkPresenter(CommonContact contact) {
        this.contact = contact;
    }

    public void loadData(int pageno, int pageSize) {
        HttpRequestHelper.getMaintenanceData("7", pageno, pageSize, new HttpCallBack() {
