...
import com.sc.clgg.adapter.CircleDepositRecordAdapter
 ...
 */
class CircleDepositRecordFragment : Fragment() {
    private val mTrafficDetailAdapter = CircleDepositRecordAdapter()
