...
public abstract class CLGGRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected CLGGRecyclerViewAdapter(Context context) {
        ctx = context;
    ...
    protected int getFooterItemCount() {
        return openLoadMoreFeature() ? 1 : 0;
    }

    public boolean openLoadMoreFeature() {
        try {
            return getContentItemCount() >= 10 && !loadComplete;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
    ...
    protected RecyclerView.ViewHolder onCreateFooterItemViewHolder(ViewGroup parent, int footerViewType) {
        ...
        return null;
        /*QDLoadingMoreView loadView = (QDLoadingMoreView) mInflater.inflate(R.layout.qd_list_loading_more_view, parent, false);
		ListLoadingMoreViewHolder holder = new ListLoadingMoreViewHolder(loadView);
		return holder;*/
    }
