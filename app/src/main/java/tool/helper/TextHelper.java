...
public enum TextHelper {
    ...
    public Spannable setTextStyle(Context context, String s1, int dp1, @ColorRes int id1, String s2, int dp2, @ColorRes int id2) {
        ...
        spannable.setSpan(new AbsoluteSizeSpan(MeasureUtils.dp2px(context, dp1)), 0, s1.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        if (!TextUtils.isEmpty(s2) && MeasureUtils.dp2px(context, dp2) > 0) {
            spannable.setSpan(new AbsoluteSizeSpan(MeasureUtils.dp2px(context, dp2)), s1.length(), spannable.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public Spannable setSpannable(Context context, String[] strArray, @ColorRes int[] colorArray, int[] spArray) {
        ...
        for (int i = 0, size = strArray.length; i < size; i++) {
            ...
            spannable.setSpan(new AbsoluteSizeSpan(MeasureUtils.sp2px(context, spArray[i])), startPosition, endPosition, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
