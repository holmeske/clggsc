...
public class RefreshViewManager {
    ...
    public void initSettings(Context context, boolean showFootView) {
        ...
        ImageView refreshArrow = (ImageView) headerView.getView().findViewById(R.id.iv_arrow);
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) refreshArrow.getLayoutParams();
        layoutParams.width = MeasureUtils.dp2px(context, 18);
        layoutParams.height = MeasureUtils.dp2px(context, 18);

        TextView tv = (TextView) headerView.getView().findViewById(R.id.tv);
        tv.setTextSize(13);
